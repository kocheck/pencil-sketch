...
export type DispatchFn = (node: PenNode, parent: any, symbolMap: Map<string, any>) => any

export function convertPenFrame(node: PenFrameNode, parent: any, symbolMap: Map<string, any>, dispatch: DispatchFn): any {
